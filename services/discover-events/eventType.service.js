...
export const getEventTypeById = async (eventTypeId) => {
    try {
        const response = await api.get(`/event/get-event-type-by-id/${eventTypeId}`);
        return response.data;
    } catch (error) {
...
export const updateEventType = async (eventTypeId, eventTypeData) => {
    try {
        const response = await api.put(`/event/update-event-type/${eventTypeId}`, eventTypeData);
        return response.data;
    } catch (error) {
...
export const deleteEventType = async (eventTypeId) => {
    try {
        const response = await api.delete(`/event/delete-event-type/${eventTypeId}`);
        return response.data;
    } catch (error) {
