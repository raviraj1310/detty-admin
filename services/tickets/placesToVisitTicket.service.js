...
export const getAllActivityTickets = async (params = {}) => {
    try {
        const response = await api.get('/activity-type/get-all-activity-tickets', { params });
...
export const createActivityTicket = async (ticketData) => {
    try {
        const response = await api.post('/activity-type/create-activity-ticket', ticketData);
        return response.data;
    } catch (error) {
...
export const getActivityTicketById = async (ticketId) => {
    try {
        const response = await api.get(`/activity-type/get-ticket-by-id/${ticketId}`);
        return response.data;
    } catch (error) {
...
export const updateActivityTicket = async (ticketId, ticketData) => {
    try {
        const response = await api.put(`/activity-type/update-ticket/${ticketId}`, ticketData);
        return response.data;
    } catch (error) {
...
export const deleteActivityTicket = async (ticketId) => {
    try {
        const response = await api.delete(`/activity-type/delete-ticket/${ticketId}`);
        return response.data;
    } catch (error) {
