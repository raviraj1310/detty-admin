...
export const getAllActivities = async (params = {}) => {
  try {
    const response = await api.get("/activity-type/get-all-activity", {
      params,
    });
...
export const getActivityById = async (activityId) => {
  try {
    const response = await api.get(
      `/activity-type/get-activity-by-id/${activityId}`
    );
    return response.data;
  } catch (error) {
...
export const deleteActivity = async (activityId) => {
  try {
    const response = await api.delete(
      `/activity-type/delete-activity/${activityId}`
    );
    return response.data;
  } catch (error) {
...
export const getIdWiseActivityBookings = async (activityId) => {
  try {
    const response = await api.get(
      `/activity-type/get-activity-bookings/${activityId}`
    );
    return response.data;
  } catch (error) {
...
export const downloadActivityBookedTicket = async (bookingId, activityId) => {
  try {
    ...
    const url = aidStr
      ? `/user-activity/download-ticket/${encodeURIComponent(
          idStr
        )}?activityId=${encodeURIComponent(aidStr)}`
...
export const viewActivityBookedTicket = async (bookingId) => {
  try {
    const idStr = String(bookingId || "").trim();
    const response = await api.get(
      `/user-activity/get-activity-ticket-detail/${encodeURIComponent(idStr)}`
    );
    return response.data;
  } catch (error) {
...
export const copyActivityById = async (id) => {
  try {
    const response = await api.post(`/activity-type/copy-activity/${id}`);
    return response.data;
  } catch (error) {
