...
export default function LoginForm() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      // Extract user role from nested user
      const userRole =
      ...
      // Success message handled by redirect; optionally show inline message
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5 px-6 pb-6">
      ...
      <div className="flex items-center justify-between text-sm">
        ...
        <Link href="/forgot_password" className="px-0 text-orange-600 hover:text-orange-700">Forgot Password?</Link>
      </div>
