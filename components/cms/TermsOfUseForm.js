      ...
      <div className="bg-gray-100 p-3 rounded-xl">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-3">
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 mb-3 border-b pb-2 border-gray-200">
            <h2 className="text-base font-semibold text-gray-900">Terms of Use Details</h2>
            <button
              onClick={handleSave}
              disabled={saving}
          ...
          <div>
            ...
            />
            <label className="block text-xs font-medium text-gray-700 mb-1 mt-3">Terms of Use<span className="text-red-500">*</span></label>
            <TiptapEditor
