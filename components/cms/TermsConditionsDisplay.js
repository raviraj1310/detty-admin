...
import { getTermsCondition } from '@/services/cms/terms-privacy.service';
import '@/components/editor/tiptap-editor.css';

export default function TermsConditionsDisplay() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 sm:p-8 lg:p-12">
      ...
      {/* This is the key part - use tiptap-content class to render HTML with proper spacing */}
      <div 
