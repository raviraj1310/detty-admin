...
const BOOKING_DATA = {
  ...
  retreatName: 'Wellness & Fitness Retreat',
  retreatImage: '/images/dashboard/image-1.webp', // Placeholder
          ...
          <div className='mb-8 flex items-start justify-between'>
            <div className='flex items-start gap-4'>
              <div className='relative h-16 w-16 overflow-hidden rounded-lg bg-gray-100'>
                <Image
                  src={BOOKING_DATA.retreatImage}
                  alt={BOOKING_DATA.retreatName}
                  fill
