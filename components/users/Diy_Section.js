...
export default function DIYPage() {
    ...
    const filteredBundles = diyBundleData.filter(bundle => {
        ...
        const matchesText = name.includes(term) || infoText.includes(term) || addedStr.includes(term);
                    ...
                    <table className="w-full">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            {filteredBundles.map((bundle) => (
                                <tr key={bundle.id} className="hover:bg-gray-50 border-b border-gray-100">
                                    ...
                                    <td className="px-3 py-3 whitespace-nowrap">
                                        <div className="flex items-center">
                                            <div className="flex-shrink-0 h-10 w-10">
                                                ...
                                                />
                                                <div className="h-10 w-10 rounded-lg bg-gradient-to-br from-orange-400 to-red-500 flex items-center justify-center" style={{display: 'none'}}>
                                            ...
                                            <div className="ml-3">
                                                <div className="text-sm font-medium text-gray-900 leading-tight">{bundle.bundleName}</div>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td className="px-3 py-3 whitespace-nowrap">
                                        <span className="text-sm font-semibold text-gray-900">{bundle.bundleAmount}</span>
                                    </td>
                                    <td className="px-3 py-3 whitespace-nowrap">
                                        <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${getStatusColor(bundle.status)}`}>
                                            • {bundle.status}
                                        </span>
                                    </td>
                                    <td className="px-3 py-3 whitespace-nowrap">
                                        <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${getPaymentStatusColor(bundle.paymentStatus)}`}>
