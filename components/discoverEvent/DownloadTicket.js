          ...
          <div className='p-6'>
                    ...
                    <div className='absolute inset-0 grid grid-cols-8 grid-rows-8'>
                      {Array.from({ length: 64 }, (_, i) => (
                        <div
                          ...
                          className={`${
                            [
                              0, 1, 2, 3, 4, 5, 6, 8, 14, 16, 22, 24, 30, 32,
                              38, 40, 46, 48, 49, 50, 51, 52, 53, 54, 56, 62
                            ].includes(i)
                              ? 'bg-black'
                              : 'bg-white'
                          }`}
            ...
            <div className='mb-6'>
              ...
              <div className='flex justify-between items-center'>
                ...
                <span className='font-bold text-[#FF5733] text-lg'>
                  ₦6,000.00
                </span>
              </div>
              <hr className='my-4 border-dashed border-gray-400' />
