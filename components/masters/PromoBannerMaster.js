...
export default function PromoBannerMaster() {
    ...
    try {
      ...
      if (editingId) {
        if (imageFile) {
          ...
          await updatePromoBanner(editingId, {
  ...
  const startEdit = async (id) => {
    ...
    try {
      ...
      try {
        const base = toImageSrc(
          d?.image || d?.imageUrl || d?.promoBanner || ""
        );
        setImageUrl(
          base ? `${base}${base.includes("?") ? "&" : "?"}t=${Date.now()}` : ""
        );
      } catch {
        setImageUrl("");
      }
  ...
  console.log(promoBanners, "promobanner");
  ...
  return (
    <div className="space-y-5 py-3 px-3">
      ...
      <div className="bg-gray-100 p-2 rounded-xl">
        <div
          ref={formSectionRef}
          className="rounded-xl border border-[#E1E6F7] bg-white p-5 shadow-[0_24px_60px_-40px_rgba(15,23,42,0.55)]"
        >
              ...
              <div className="space-y-1">
                ...
                >
                  ...
                  <button
                    ...
                    className="px-3 text-xs font-medium text-[#2D3658] bg-white transition hover:bg-[#F6F7FD] border-l border-[#E5E6EF]"
                  >
                    Crop
                  </button>
                </div>
                ...
                {(imageUrl || formData.uploadImage) && (
                  <div className="mt-1 relative inline-block">
                    <img
                      ...
                      className="w-24 h-14 object-cover rounded border border-[#E5E6EF] cursor-pointer"
                      onClick={openCropWithExisting}
                    />
                    <button
                      type="button"
        ...
        <div className="rounded-xl border border-[#E1E6F7] bg-white p-4">
          ...
          <div className="overflow-visible rounded-xl border border-[#E5E8F5]">
            ...
            <div className="divide-y divide-[#EEF1FA] bg-white">
                    ...
                    <div className="col-span-3 flex items-center self-center">
                      <div className="w-24 h-14 rounded-lg overflow-hidden border border-[#E5E6EF] bg-gray-100">
                        {banner.image && !failedImages[banner._id] ? (
                          ...
                          <div className="w-full h-full bg-gradient-to-r from-orange-400 to-red-500 flex items-center justify-center text-white text-[10px] font-medium">
                            Banner
                          </div>
                        )}
                      </div>
                    </div>
                    <div className="col-span-2 self-center text-xs text-[#5E6582] break-all whitespace-normal leading-4 pr-2">
                      {banner.link}
                    </div>
                    ...
                    <div className="col-span-1 flex items-center justify-end">
                      <div className="relative">
                        ...
                        {menuOpenId === banner._id && (
                          <div
                            data-menu-content
                            className="absolute right-0 top-full mt-1 w-32 rounded-md border border-[#E5E8F6] bg-white shadow-lg z-50"
                          >
                            <button
              ...
              {!loading && !error && filteredPromoBanners.length === 0 && (
