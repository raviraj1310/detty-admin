      ...
      <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-12">
        ...
        <div className="mb-6">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">
            Tickets Booked{headerName ? ` - ${headerName}` : ""}
          </h1>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <p className="text-3xl font-bold text-white">
                    {card.value}{" "}
                    <span className="text-lg font-normal">{card.amount}</span>
                  </p>
                </div>
              </div>
            </div>
                ...
                rows.map((booking) => (
                  ...
                  >
                    ...
                    <div className="flex items-center self-center">
                      <span
                        className={`inline-flex items-center justify-center rounded-full px-3 py-1 text-xs font-semibold ${booking.statusClass}`}
                      >
                    ...
                    <div className="flex items-center self-center">
                      <span
                        className={`inline-flex items-center justify-center rounded-full px-3 py-1 text-xs font-semibold ${booking.activityStatusClass}`}
                      >
                        {booking.status}
                      </span>
                    </div>
