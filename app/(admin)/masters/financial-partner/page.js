import FinancialPartnersMaster from '@/components/masters/FinancialPartnersMaster'

export default function FinancialPartnerMasterPage () {
  return (
